...
const darkTheme = {
  ...
  "--color-hero-scroll-arrow": "var(--color-accent-scroll)",
  "--font-weight-hero-scroll": "300",
  "--opacity-hero-scroll-min": "0.45",
  "--shadow-hero-scroll": "none",
...
const lightTheme = {
  ...
  "--color-hero-scroll-arrow": "var(--color-accent)",
  "--font-weight-hero-scroll": "500",
  "--opacity-hero-scroll-min": "0.72",
  "--shadow-hero-scroll":
    "0 0 2px var(--color-canvas), 0 0 6px var(--color-canvas), 0 0 12px var(--color-canvas)",
  ...
  "--color-hero-scroll": "var(--color-text-primary)",
